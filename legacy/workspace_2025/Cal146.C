...
void Cal146(const int run, const int Cmin, const int Cmax, const int num)
{
   ...
   myc_1->Divide(4,4);
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc0ch0 - (1834) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc0ch16- (1824) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc1ch0 - (1721) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc1ch16- (1725) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc2ch0 - (1610) >> hx1 "); 
                  t->SetLineColor(1); myc_1->cd( 2); t->Fit("gaus","adc2ch1 - (1639) >> hx2 "); 
                  t->SetLineColor(1); myc_1->cd( 3); t->Fit("gaus","adc2ch2 - (1686) >> hx3 "); 
                  t->SetLineColor(1); myc_1->cd( 4); t->Fit("gaus","adc2ch3 - (1668) >> hx4 "); 
                  t->SetLineColor(1); myc_1->cd( 5); t->Fit("gaus","adc2ch4 - (1704) >> hx5 "); 
                  t->SetLineColor(1); myc_1->cd( 6); t->Fit("gaus","adc2ch5 - (1653) >> hx6 "); 
                  t->SetLineColor(1); myc_1->cd( 7); t->Fit("gaus","adc2ch6 - (1653) >> hx7 "); 
                  t->SetLineColor(1); myc_1->cd( 8); t->Fit("gaus","adc2ch7 - (1700) >> hx8 "); 
                  t->SetLineColor(1); myc_1->cd( 9); t->Fit("gaus","adc2ch8 - (1578) >> hx9 "); 
                  t->SetLineColor(1); myc_1->cd(10); t->Fit("gaus","adc2ch9 - (-2567) >> hx10"); 
                  t->SetLineColor(1); myc_1->cd(11); t->Fit("gaus","adc2ch10- (1768) >> hx11"); 
                  t->SetLineColor(1); myc_1->cd(12); t->Fit("gaus","adc2ch11- (1744) >> hx12"); 
                  t->SetLineColor(1); myc_1->cd(13); t->Fit("gaus","adc2ch12- (1802) >> hx13"); 
                  t->SetLineColor(1); myc_1->cd(14); t->Fit("gaus","adc2ch13- (1802) >> hx14"); 
                  t->SetLineColor(1); myc_1->cd(15); t->Fit("gaus","adc2ch14- (1780) >> hx15"); 
                  t->SetLineColor(1); myc_1->cd(16); t->Fit("gaus","adc2ch15- (1764) >> hx16"); }
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc2ch16- (1721) >> hx1 "); 
                  t->SetLineColor(1); myc_1->cd( 2); t->Fit("gaus","adc2ch17- (1791) >> hx2 "); 
                  t->SetLineColor(1); myc_1->cd( 3); t->Fit("gaus","adc2ch18- (1833) >> hx3 "); 
                  t->SetLineColor(1); myc_1->cd( 4); t->Fit("gaus","adc2ch19- (1678) >> hx4 "); 
                  t->SetLineColor(1); myc_1->cd( 5); t->Fit("gaus","adc2ch20- (1672) >> hx5 "); 
                  t->SetLineColor(1); myc_1->cd( 6); t->Fit("gaus","adc2ch21- (1680) >> hx6 "); 
                  t->SetLineColor(1); myc_1->cd( 7); t->Fit("gaus","adc2ch22- (1768) >> hx7 "); 
                  t->SetLineColor(1); myc_1->cd( 8); t->Fit("gaus","adc2ch23- (1738) >> hx8 "); 
                  t->SetLineColor(1); myc_1->cd( 9); t->Fit("gaus","adc2ch24- (1783) >> hx9 "); 
                  t->SetLineColor(1); myc_1->cd(10); t->Fit("gaus","adc2ch25- (1745) >> hx10"); 
                  t->SetLineColor(1); myc_1->cd(11); t->Fit("gaus","adc2ch26- (1727) >> hx11"); 
                  t->SetLineColor(1); myc_1->cd(12); t->Fit("gaus","adc2ch27- (1645) >> hx12"); 
                  t->SetLineColor(1); myc_1->cd(13); t->Fit("gaus","adc2ch28- (1690) >> hx13"); 
                  t->SetLineColor(1); myc_1->cd(14); t->Fit("gaus","adc2ch29- (1482) >> hx14"); 
                  t->SetLineColor(1); myc_1->cd(15); t->Fit("gaus","adc2ch30- (1765) >> hx15"); 
                  t->SetLineColor(1); myc_1->cd(16); t->Fit("gaus","adc2ch31- (1821) >> hx16"); }
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc3ch0 - (1840) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc3ch16- (1832) >> hx1 "); 
