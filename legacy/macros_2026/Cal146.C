...
void Cal146(const int run, const int Cmin, const int Cmax, const int num)
{
   ...
   myc_1->Divide(4,4);
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc0ch0 - (0) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc0ch16- (0) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc1ch0 - (0) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc1ch16- (0) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc2ch0 - (0) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc2ch16- (0) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc3ch0 - (0) >> hx1 "); 
              ...
              {   t->SetLineColor(1); myc_1->cd( 1); t->Fit("gaus","adc3ch16- (0) >> hx1 "); 
